 ...
 */
final class Version20240829085359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(12) NOT NULL, name VARCHAR(100) NOT NULL, expiration DATE NOT NULL, iduser INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `orders` (id INT AUTO_INCREMENT NOT NULL, id_user INT NOT NULL, order_date DATETIME NOT NULL, gift_wrapping SMALLINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
